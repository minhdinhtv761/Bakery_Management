...
namespace Bakery_Management
{
    public partial class fLogin : Form
    {
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            {
                Account loginAccount = Bakery_Management.DAO.AccountDAO.Instance.GetAccountByUserName(userName);
        ...
        bool Login(string userName, string passWord)
        {
            ...
            return Bakery_Management.DAO.AccountDAO.Instance.Login(userName, passWord);
        }
